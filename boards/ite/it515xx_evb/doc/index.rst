...
- 6 SMBus hosts, 3 targets, with 9 SMBus channels, compatible with I2C
- I3C target: Support two I3C controllers, compliant with the MIPI I3C v1.0 SEPC.
...
:zephyr_file:`boards/ite/it515xx_evb/it515xx_evb_defconfig` Kconfig file.
