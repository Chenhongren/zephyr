...
int libi3c_reg_read_byte(const struct device *controller_dev, const struct device *dummy_dev,
			 const struct device *target_dev, const uint8_t reg_addr,
			 uint8_t *reg_value)
{
	int ret;
	struct i3c_device_desc *target;
...
int libi3c_reg_write_byte(const struct device *controller_dev, const struct device *dummy_dev,
			  const uint8_t reg_addr, const uint8_t reg_value)
{
	int ret;
	struct i3c_device_desc *target;
...
int libi3c_reg_update_byte(const struct device *controller_dev, const struct device *dummy_dev,
			   const struct device *target_dev, const uint8_t reg_addr, uint8_t mask,
			   uint8_t value)
{
	int ret;
	struct i3c_device_desc *target;
	 ...
	 */
	ret = i3c_reg_update_byte(target, reg_addr, mask, value);
	if (ret) {
